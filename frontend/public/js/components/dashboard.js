...
import { badge, timeSince, scoreBar, loading, showToast } from '../utils/ui.js';
...
function renderRouteRow(r) {
    ...
    <td>
      <div class="driver-cell">
        <div class="driver-avatar">${driver?.name?.split(' ').map((w) => w[0]).join('').slice(0, 2).toUpperCase() || 'NA'}</div>
